...
function List (key, options) {
	...
	Object.defineProperty(this, 'one', { get: function () {
		return this.get('one') || this.set('one', this.label);
	} });
	Object.defineProperty(this, 'few', { get: function () {
		return this.get('few') || this.set('few', this.label);
	} });
	Object.defineProperty(this, 'many', { get: function () {
		return this.get('many') || this.set('many', this.label);
	} });
